...
# parametre olarak gönderilen dizideki tüm elemanlar min_heapify fonksiyonuna gönderilir ve en sondan o diziyi heap haline getirir.
...
# heapsort, dizi sıralamak için kullanilir.
# gonderilen dizideki kok ile son elemanın yeri degisir. 
# son eleman yeni listeye eklenir. Eski listeden silinir ve heapify'e yollanir.
# Boylece liste kucukten büyüge siralanir.
def heapsort(array):
    array = array.copy()
